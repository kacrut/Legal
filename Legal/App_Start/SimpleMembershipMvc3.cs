...
[assembly: WebActivator.PreApplicationStartMethod(typeof(Legal.App_Start.SimpleMembershipMvc3), "Start")]
[assembly: WebActivator.PostApplicationStartMethod(typeof(Legal.App_Start.SimpleMembershipMvc3), "Initialize")]

namespace Legal.App_Start
{
	public static class SimpleMembershipMvc3
	{
		...
		public static void Initialize()
		{
            ...
            WebSecurity.InitializeDatabaseConnection(connectionStringName: "ESKAPEDEContext", userTableName: "User", userIdColumn: "ID", userNameColumn: "Username", autoCreateTables: false);
