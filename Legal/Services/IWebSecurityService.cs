...
namespace Legal.Services
{
	public interface IWebSecurityService
	{
        ...
        string CreateUserAndAccount(string userName, string password, string nIK, string firstName, string lastName, string rekening, string email, int positionID, object propertyValues = null, bool requireConfirmationToken = false);
        //string CreateUserAndAccount(string userName, string password, object propertyValues = null, bool requireConfirmationToken = false);
        ...
        string GetUserDivision(string userName);
	}
}